...
`,
		PreRun: func(cmd *cobra.Command, args []string) {
			...
			conf.ApplicationConfig.ApplicationRunName = viper.GetString("server.run_name")
...
func InitCmd() *cobra.Command {
	...
	cmd.PersistentFlags().StringVar(&conf.ApplicationConfig.Port, "port", conf.ApplicationConfig.Port, "the application start port")
	cmd.PersistentFlags().StringVar(&conf.ApplicationConfig.ApplicationRunName, "name", conf.ApplicationConfig.CApplicationName, "the application run time name")
	...
	_ = viper.BindPFlag("server.run_name", cmd.PersistentFlags().Lookup("name"))
	...
	_ = viper.BindEnv("server.run_name")
	...
	viper.SetDefault("server.run_name", conf.ApplicationConfig.ApplicationRunName)
